            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            {{--                            <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('img_proflie') }}</label>--}}

                            <div class="col-md-6" style="text-align: center;margin: 0 auto;">

                                <div class="input-group mb-3">
                                    <div class="custom-file">
                                        <input type="file" name="img_profile" class="imgProfile custom-file-input inputfile @error('img_profile') is-invalid @enderror" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
                                        <label class="custom-file-label" for="inputGroupFile01">Choose Profile Picture</label>
                                    </div>
                                </div>
                                <img src="" id="profileImg" width="200px" />
